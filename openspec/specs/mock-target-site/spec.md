...
- 技术选型：Node.js built-in http (via Playwright test fixtures)
- 端口：动态分配可用端口（避免冲突）
- 启动时间：测试前启动，测试结束后关闭
- 功能：
...
- 路径：`frontend/tests/e2e/fixtures/mock-server/list-page.html`
- 结构：
...
- 路径：
  - `frontend/tests/e2e/fixtures/mock-server/content-page-1.html`
  - `frontend/tests/e2e/fixtures/mock-server/content-page-2.html`
- 结构：
  - 标题选择器：`h1.title`
