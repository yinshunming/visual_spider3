...
- Name: content-list.spec.ts >> 内容列表页 E2E 测试 >> E2E-002 显示内容列表 - 应显示 sourceUrl、status、createdAt 列
- Location: tests\e2e\content-list.spec.ts:16:3
  ...
  - main [ref=e7]:
    - generic [ref=e8]:
      ...
      - generic [ref=e21]:
        ...
        - img [ref=e51]
      - generic [ref=e53]:
        - generic [ref=e54]: Total 0
        - generic [ref=e57] [cursor=pointer]:
          - generic:
            - combobox [ref=e59]
            - generic [ref=e60]: 20/page
          - img [ref=e63]
        - button "Go to previous page" [disabled] [ref=e65]:
          - generic:
            - img
        - list [ref=e66]:
          - listitem "page 1" [ref=e67]: "1"
        - button "Go to next page" [disabled] [ref=e68]:
          - generic:
            - img
```
